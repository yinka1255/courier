...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About FreightCo'.
Please install and activate it before starting to use the theme FreightCo.
...
Theme documentation is available on http://freightco.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in FreightCo is Fontello.
