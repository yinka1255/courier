...
if ( !function_exists( 'freightco_wpml_tgmpa_required_plugins' ) ) {
	//Handler of the add_filter('freightco_filter_tgmpa_required_plugins', 'freightco_wpml_tgmpa_required_plugins');
...
if (!function_exists('freightco_wpml_duplicate_theme_options')) {
	//Handler of the add_action('freightco_action_just_save_options', 'freightco_wpml_duplicate_theme_options', 10, 1);
...
if (!function_exists('freightco_wpml_duplicate_trx_addons_options')) {
	//Handler of the add_filter('freightco_filter_options_save', 'freightco_wpml_duplicate_trx_addons_options', 10, 2);
...
if (!function_exists('freightco_wpml_get_theme_mod')) {
	//Handler of the add_filter('theme_mod_xxx', 'freightco_wpml_get_theme_mod');
...
if (!function_exists('freightco_wpml_customizer_vars')) {
	//Handler of the add_filter( 'freightco_filter_customizer_vars', 'freightco_wpml_customizer_vars');
...
if ( !function_exists( 'freightco_wpml_merge_styles' ) ) {
	//Handler of the add_filter( 'freightco_filter_merge_styles', 'freightco_wpml_merge_styles');
