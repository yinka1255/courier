...
if ( !function_exists( 'freightco_trx_addons_add_theme_vars' ) ) {
	add_filter( 'freightco_filter_add_theme_vars', 'freightco_trx_addons_add_theme_vars', 10, 2 );
	function freightco_trx_addons_add_theme_vars($rez, $vars) {
...
if (!function_exists('freightco_trx_addons_get_css')) {
	add_filter('freightco_filter_get_css', 'freightco_trx_addons_get_css', 10, 2);
	function freightco_trx_addons_get_css($css, $args) {
...
.trx_addons_list_number li .trx_addons_fontsize_1125em {
	color: {$colors['text_dark']};
}
...
.swiper-pagination .swiper-pagination-button.swiper-pagination-button-active{
	border-color: transparent;
	background-color: transparent;
}
...
.scheme_self.top_panel .widget_contacts .contacts_info,
.scheme_self.footer_wrap .widget_contacts .contacts_info {
	color: {$colors['alter_text']};
}
.scheme_self.top_panel .widget_contacts .contacts_info span:before,
.scheme_self.top_panel .widget_contacts .contacts_info > div > a:before,
.scheme_self.top_panel .widget_contacts .contacts_info > a:before,
...
.scheme_self.top_panel .widget_contacts .contacts_info .contacts_item_label,
.scheme_self.top_panel .widget_contacts .contacts_info span a,
.scheme_self.top_panel .widget_contacts .contacts_info > div > a,
.scheme_self.top_panel .widget_contacts .contacts_info > a,
.scheme_self.footer_wrap .widget_contacts .contacts_info .contacts_item_label,
...
.scheme_self.top_panel .widget_contacts .contacts_info span a:hover,
.scheme_self.top_panel .widget_contacts .contacts_info > div > a:hover,
.scheme_self.top_panel .widget_contacts .contacts_info > a:hover,
...
.scheme_self.top_panel .widget_contacts .contacts_info > div:before,
.scheme_self.footer_wrap .widget_contacts .contacts_info > div:before{
	color: {$colors['alter_dark']};
}
.scheme_self.top_panel .widget_contacts .contacts_info > div a{
...
.scheme_self.top_panel .sc_layouts_row_type_narrow .widget_contacts .contacts_info > div:after {
	color: {$colors['alter_bd_color']};
}

.sc_layouts_row_type_narrow .sc_layouts_item:after {
	color: {$colors['bd_color']};
}

.top_panel .sc_layouts_row_type_narrow.scheme_self .sc_layouts_item:after,
.scheme_self.top_panel .sc_layouts_row_type_narrow .sc_layouts_item:after,
.scheme_self.top_panel .sc_layouts_row_type_narrow.scheme_self .sc_layouts_item:after {
	color: {$colors['alter_bd_color']};
}
...
.sc_title_container.with_border.border_alter_color:before {
	color:{$colors['text_dark']};
}
...
.scheme_self.sc_title.sc_title_default .sc_title_container.with_border:before{
	color: {$colors['text_dark']};
}

.scheme_self.sc_title.sc_title_default .sc_title_container .sc_item_subtitle{
	color: {$colors['text_dark']};
}
.scheme_self.sc_title.sc_title_default .sc_title_container .sc_item_title {
	color: {$colors['inverse_dark']};
}
.scheme_self.sc_title.sc_title_default .sc_item_descr{
	color: {$colors['text_dark']};
}

.scheme_self.sc_title.sc_title_default .sc_item_descr .sc_button{
	color: {$colors['inverse_link']};
	background-color: {$colors['inverse_dark']};
}
.scheme_self.sc_title.sc_title_default .sc_item_descr .sc_button:hover{
	color: {$colors['inverse_dark']};
	background-color: {$colors['inverse_link']};
}

.scheme_self.sc_title.sc_title_default.alter .sc_title_container .sc_item_subtitle{
	color: {$colors['inverse_dark']};
}
.scheme_self.sc_title.sc_title_default.alter .sc_title_container .sc_item_title {
	color: {$colors['text_dark']};
}

.scheme_self.sc_title.sc_title_default.alter.alter_color .sc_title_container .sc_item_subtitle{
	color: {$colors['text_link']};
}
.scheme_self.sc_title.sc_title_default.alter.alter_color .sc_title_container .sc_item_title {
	color: {$colors['text_dark']};
}
...
.sc_blogger .sc_blogger_item .sc_blogger_item_title a:hover {
	color: {$colors['alter_link']};
}
.sc_blogger .sc_blogger_item .post_meta .post_meta_item:before,
.sc_blogger .sc_blogger_item .post_meta  a.post_meta_item,
.sc_blogger .sc_blogger_item .post_meta .post_meta_item a{
	color: {$colors['alter_dark']};
}
.sc_blogger .sc_blogger_item .post_meta  a.post_meta_item:hover,
.sc_blogger .sc_blogger_item .post_meta .post_meta_item a:hover{
	color: {$colors['alter_link']};
}

.sc_blogger .sc_blogger_item .post_meta .post_meta_item:after, 
.sc_blogger .sc_blogger_item .post_meta .post_meta_item.post_edit:after, 
.sc_blogger .sc_blogger_item .post_meta .vc_inline-link:after {
	color: {$colors['alter_bd_color']};
}


.sc_blogger .sc_blogger_item .sc_blogger_item_content {
	color: {$colors['alter_text']};
}
.sc_blogger .sc_blogger_item .sc_blogger_item_button a,
.sc_blogger .sc_blogger_item .sc_blogger_item_button a:after{
	color: {$colors['alter_link']};
}
.sc_blogger .sc_blogger_item .sc_blogger_item_button a:hover:after,
.sc_blogger .sc_blogger_item .sc_blogger_item_button a:hover {
...
.sc_icons .sc_icons_item .sc_icons_item_title:after,
...
.scheme_self.footer_wrap .sc_icons .sc_icons_item .sc_icons_item_title:after,
...
.sc_icons .sc_icons_item_description span span {
	color: {$colors['text']};
}
.sc_icons .sc_icons_item.with_image_bg .sc_icons_item_description span span {
	color: {$colors['alter_dark']};
}

.sc_icons.sc_icons_modern .sc_icons_item .sc_icons_item_title span:first-child:not(:last-child){
	color: {$colors['alter_link']};
}
.sc_icons.sc_icons_modern .sc_icons_item .sc_button:after,
.sc_icons.sc_icons_modern .sc_icons_item .sc_button{
	color: {$colors['alter_link']};
}
.sc_icons.sc_icons_modern .sc_icons_item .sc_button:hover:after,
.sc_icons.sc_icons_modern .sc_icons_item .sc_button:hover{
	color: {$colors['alter_hover']} !important;
}

.sc_icons.sc_icons_modern.sc_icons_size_medium .sc_icons_item .sc_button:after,
.sc_icons.sc_icons_modern.sc_icons_size_medium .sc_icons_item .sc_button{
	color: {$colors['alter_hover']} !important;
}

.sc_icons.sc_icons_modern.sc_icons_size_medium .sc_icons_item .sc_button:hover:after,
.sc_icons.sc_icons_modern.sc_icons_size_medium .sc_icons_item .sc_button:hover{
	color: {$colors['alter_link']} !important;
}

.sc_icons.sc_icons_modern .sc_icons_item .sc_icons_item_description ol,
.sc_icons.sc_icons_modern .sc_icons_item .sc_icons_item_description ul{
	color: {$colors['alter_dark']};
}


/* modern alter */
.sc_icons.sc_icons_modern.alter .sc_icons_item:before {
	background-color:  {$colors['alter_link_08']};
}
.sc_icons.sc_icons_modern.alter .sc_icons_icon {
	color:  {$colors['alter_link2']};
}
.sc_icons.sc_icons_modern.alter .sc_icons_item .sc_icons_item_title span:first-child:not(:last-child) {
	color:  {$colors['alter_link2']};
}

.sc_icons.sc_icons_modern.alter .sc_icons_item_description {
	color:  {$colors['alter_dark']};
}

.sc_icons.sc_icons_modern.alter .sc_icons_item .sc_button:after,
.sc_icons.sc_icons_modern.alter .sc_icons_item .sc_button{
	color: {$colors['alter_hover2']};
}
.sc_icons.sc_icons_modern.alter .sc_icons_item .sc_button:hover:after,
.sc_icons.sc_icons_modern.alter .sc_icons_item .sc_button:hover{
	color: {$colors['alter_link2']} !important;
}

.sc_icons.sc_icons_modern.alter .sc_icons_item_description > span > span {
	color: {$colors['alter_link2']} !important;
}

/* number */
.sc_icons.sc_icons_number .sc_icons_item_title {
	color: {$colors['text_dark']};
}
...
.sc_services_item.with_bg_image:hover:before {
	background-color: {$colors['alter_link_085']};
}
.sc_services.no_padding .sc_services_columns_wrap [class*="trx_addons_column"]:nth-child(2n+0) .sc_services_item.with_bg_image:before {
	background-color: {$colors['alter_bg_color_09']};
}
.sc_services.no_padding .sc_services_columns_wrap [class*="trx_addons_column"]:nth-child(2n+1) .sc_services_item.with_bg_image:before {
	background-color: {$colors['extra_bg_color_092']};
}

.sc_services:not(.no_padding) .sc_services_item.with_bg_image:hover .sc_services_item_icon{
	color: {$colors['alter_link2']};
}
.sc_services_item.with_bg_image .sc_services_item_title:after,
.sc_services_item.with_bg_image .sc_services_item_title a{
	color: {$colors['alter_hover']};
}

.sc_services:not(.no_padding) .sc_services_item.with_bg_image:hover .sc_services_item_title a{
	color: {$colors['alter_link2']};
}

.sc_services:not(.no_padding) .sc_services_item.with_bg_image:hover .sc_services_item_title a:hover{
	color: {$colors['alter_hover2']};
}
.sc_services_item.with_bg_image .sc_services_item_title a:hover{
	color: {$colors['alter_link']};
}

.sc_services_item.with_bg_image .sc_services_item_content{
	color: {$colors['alter_link3']};
}
.sc_services:not(.no_padding) .sc_services_item.with_bg_image:hover .sc_services_item_content{
	color: {$colors['alter_hover2']};
}

.sc_services_item.with_bg_image .sc_services_item_button a:after,
.sc_services_item.with_bg_image .sc_services_item_button a{
	color: {$colors['alter_hover']};
}
.sc_services_item.with_bg_image .sc_services_item_button a:hover:after,
.sc_services_item.with_bg_image .sc_services_item_button a:hover{
	color: {$colors['alter_link']} !important;
}
.sc_services:not(.no_padding) .sc_services_item.with_bg_image:hover .sc_services_item_button a:hover:after,
.sc_services:not(.no_padding) .sc_services_item.with_bg_image:hover .sc_services_item_button a:hover{
	color: {$colors['alter_link2']} !important;
}
...
.scheme_self.elementor-widget-trx_sc_skills .sc_skills .sc_skills_total {
	color:{$colors['inverse_dark']};
}
...
.sc_team .sc_team_item_title a:hover {
	color: {$colors['alter_link']};
}
.sc_team .alter_color .sc_team_item_title a {
	color: {$colors['alter_link2']};
}
.sc_team .alter_color .sc_team_item_title a:hover {
	color: {$colors['alter_dark']};
}
...
.we_are_hiring span.wpcf7-not-valid-tip {
    color: {$colors['text_dark']};
}
...
.wpcf7 .tracker_form_title span{
    color: {$colors['text_link']};
}
.sc_layouts_popup .wpcf7 .tracker_form_title span{
    color: {$colors['alter_link']};
}
...
.wpcf7 .tracker_form.white .wpcf7-form-control,
.wpcf7 .tracker_form.white .wpcf7-form-control:hover,
.wpcf7 .tracker_form.white .wpcf7-form-control:hover,
.wpcf7 .tracker_form.white .wpcf7-form-control.filled{
	color: {$colors['text_dark']};
	background-color: {$colors['bg_color']};
}

.wpcf7 .tracker_form.white input.wpcf7-form-control::-webkit-input-placeholder {color:{$colors['text_dark']};}
.wpcf7 .tracker_form.white input.wpcf7-form-control::-moz-placeholder          {color:{$colors['text_dark']};}/* Firefox 19+ */
.wpcf7 .tracker_form.white input.wpcf7-form-control:-moz-placeholder           {color:{$colors['text_dark']};}/* Firefox 18- */
.wpcf7 .tracker_form.white input.wpcf7-form-control:-ms-input-placeholder      {color:{$colors['text_dark']};}
...
.wpcf7 .tracker_form.white + div.wpcf7-validation-errors, 
.wpcf7 .tracker_form.white + div.wpcf7-acceptance-missing {
	color: {$colors['text_link']};
}
...
.wpcf7-field-groups .wpcf7-field-group-remove:hover,
.wpcf7-field-groups .wpcf7-field-group-add:hover {
    color: {$colors['text_link']};
    background-color: transparent;
}
...
.wpcf7 .we_are_hiring .form_title_2color span {
    color: {$colors['inverse_dark']};
}

.wpcf7 .we_are_hiring input {
    color: {$colors['alter_text']};
    background-color: {$colors['extra_bg_color']};
}

.wpcf7 .we_are_hiring input::-webkit-input-placeholder {color:{$colors['alter_text']}; opacity: 1;}
.wpcf7 .we_are_hiring input::-moz-placeholder          {color:{$colors['alter_text']}; opacity: 1;}/* Firefox 19+ */
.wpcf7 .we_are_hiring input:-moz-placeholder           {color:{$colors['alter_text']}; opacity: 1;}/* Firefox 18- */
.wpcf7 .we_are_hiring input:-ms-input-placeholder      {color:{$colors['alter_text']}; opacity: 1;}

.wpcf7 .we_are_hiring input[type="submit"] {
    color: {$colors['text_dark']};
    background-color: {$colors['alter_dark']};
}
.wpcf7 .we_are_hiring input[type="submit"]:hover {
    color: {$colors['alter_dark']};
    background-color: {$colors['text_dark']};
}
...
.we_are_hiring ~ div.wpcf7-validation-errors, 
.we_are_hiring ~ div.wpcf7-acceptance-missing {
    border-color: {$colors['text_dark']};
}
.we_are_hiring ~ div.wpcf7-mail-sent-ok {
    border-color: {$colors['text_dark']};
}
...
[id*="cp_calculatedfieldsf"] input[value="7"] ~ #fbuilder .fields.cff-dropdown-field .dfield:hover:before{
    color: {$colors['alter_dark']};
}

.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="8"] ~ #fbuilder input,
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="8"] ~ #fbuilder select,
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="10"] ~ #fbuilder input,
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="10"] ~ #fbuilder select {
    color: {$colors['alter_dark']};
    border-color: {$colors['text_dark']};
    background-color: {$colors['text_dark']};
}

.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="8"] ~ #fbuilder .fields.cff-dropdown-field .dfield:before,
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="10"] ~ #fbuilder .fields.cff-dropdown-field .dfield:before {
    color: {$colors['extra_link2']};
}

.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="8"] ~ #fbuilder input::-webkit-input-placeholder {color:{$colors['alter_dark']};}
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="8"] ~ #fbuilder input::-moz-placeholder          {color:{$colors['alter_dark']};}
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="8"] ~ #fbuilder input:-moz-placeholder           {color:{$colors['alter_dark']};}
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="8"] ~ #fbuilder input:-ms-input-placeholder      {color:{$colors['alter_dark']};}
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="10"] ~ #fbuilder input::-webkit-input-placeholder {color:{$colors['alter_dark']};}
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="10"] ~ #fbuilder input::-moz-placeholder          {color:{$colors['alter_dark']};}
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="10"] ~ #fbuilder input:-moz-placeholder           {color:{$colors['alter_dark']};}
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="10"] ~ #fbuilder input:-ms-input-placeholder      {color:{$colors['alter_dark']};}

.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="8"] ~ #fbuilder .fields.with_icon.cff-button-field.with_icon input[type="button"],
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="10"] ~ #fbuilder .fields.with_icon.cff-button-field.with_icon input[type="button"] {
    color: {$colors['alter_bg_color']};
    border-color: {$colors['extra_dark']};
    background-color: {$colors['extra_dark']};
}
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="8"] ~ #fbuilder .fields.with_icon.cff-button-field.with_icon:before,
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="10"] ~ #fbuilder .fields.with_icon.cff-button-field.with_icon:before{
    color: {$colors['alter_bg_color']};
}
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="8"] ~ #fbuilder .fields.with_icon.cff-button-field.with_icon input[type="button"]:hover,
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="10"] ~ #fbuilder .fields.with_icon.cff-button-field.with_icon input[type="button"]:hover {
    color: {$colors['extra_dark']};
    border-color: {$colors['extra_light']};
    background-color: {$colors['extra_light']};
}
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="8"] ~ #fbuilder .fields.with_icon.cff-button-field.with_icon:hover:before,
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="10"] ~ #fbuilder .fields.with_icon.cff-button-field.with_icon:hover:before{
    color: {$colors['extra_dark']};
}

.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="8"] ~ #fbuilder .fields.cff-calculated-field label,
.scheme_self.elementor-widget-html [id*="cp_calculatedfieldsf"] input[value="10"] ~ #fbuilder .fields.cff-calculated-field label {
    color: {$colors['inverse_dark']};
...
[id*="cp_calculatedfieldsf"] input[value="9"] ~ #fbuilder .fields.cff-dropdown-field .dfield:hover:before,
[id*="cp_calculatedfieldsf"] input[value="11"] ~ #fbuilder .fields.cff-dropdown-field .dfield:hover:before{
    color: {$colors['alter_dark']};
}


/* id 13 */
[id*="cp_calculatedfieldsf"] input[value="13"] ~ #fbuilder .fields.form_title {
    color: {$colors['text_dark']};
}
...
[id*="cp_calculatedfieldsf"] input[value="13"] ~ #fbuilder .fields input[type="checkbox"] + span:before {
    color: {$colors['text_link']};
    border-color: {$colors['text_dark']};
    background-color: {$colors['text_dark']};
}
...
[id*="cp_calculatedfieldsf"] input[value="13"] ~ #fbuilder .fields.flex_th {
    color: {$colors['text_dark']};
}
...
[id*="cp_calculatedfieldsf"] input[value="13"] ~ #fbuilder .total_fields input{
    color: {$colors['text']};
    background-color: {$colors['bg_color']};
}

[id*="cp_calculatedfieldsf"] input[value="13"] ~ #fbuilder .total_fields input::-webkit-input-placeholder {color:{$colors['text']};}
[id*="cp_calculatedfieldsf"] input[value="13"] ~ #fbuilder .total_fields input::-moz-placeholder          {color:{$colors['text']};}
[id*="cp_calculatedfieldsf"] input[value="13"] ~ #fbuilder .total_fields input:-moz-placeholder           {color:{$colors['text']};}
[id*="cp_calculatedfieldsf"] input[value="13"] ~ #fbuilder .total_fields input:-ms-input-placeholder      {color:{$colors['text']};}
...
#trx_addons_login_popup .trx_addons_popup_form_field a:hover {
    color: {$colors['alter_hover']};
}
