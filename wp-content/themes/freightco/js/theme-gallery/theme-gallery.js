...
;(function(window) {
	...
	GalleryFx.prototype._init = function() {
		...
		freightco_when_images_loaded( jQuery(this.galleryEl), function() {
			// init/bind events
			self._initEvents();
	...
	jQuery(document).on('action.init_hidden_elements', function(e, cont) {
		...
		cont.find('.portfolio_wrap,.masonry_wrap,.post_format_gallery .gallery').each(function() {
			...
			if (!portfolio.hasClass('inited')) {
				...
				freightco_when_images_loaded( portfolio, function() {
					// item selector
		...
		cont.find('.gallery_wrap:not(.inited)').each(function(idx) {
			...
			if (!FREIGHTCO_STORAGE['GalleryFx']) FREIGHTCO_STORAGE['GalleryFx'] = {};
			...
			FREIGHTCO_STORAGE['GalleryFx'][id] = new GalleryFx(this, {
