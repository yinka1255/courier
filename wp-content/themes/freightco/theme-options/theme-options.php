...
if ( !function_exists( 'freightco_options_add_scripts' ) ) {
	//Handler of the add_action("admin_enqueue_scripts", 'freightco_options_add_scripts');
		...
		<div class="freightco_options">
			...
			<form id="freightco_options_form" action="#" method="post" enctype="multipart/form-data">
				...
				<div class="freightco_options_buttons">
					<input type="button" class="freightco_options_button_submit" value="<?php esc_html_e('Save Options', 'freightco'); ?>">
				</div>
			</form>
		</div>
		<?php
