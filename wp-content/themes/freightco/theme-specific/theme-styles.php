...
if (!function_exists('freightco_customizer_get_css')) {

	function freightco_customizer_get_css($args=array()) {
		...
		if ($fonts) {
			...
			$fonts = freightco_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('freightco_filter_get_css', $rez, array('fonts' => $fonts));
			$css['fonts'] = $rez['fonts'];
		}
		...
		//---------------------------------------------
		if ($vars === null) {
			$vars = freightco_get_theme_vars();
		}
		
		if ($vars) {

			// Make theme-specific fonts rules
			$vars = freightco_customizer_add_theme_vars($vars);
			extract($vars);
...
CSS;
			$rez = apply_filters('freightco_filter_get_css', $rez, array('vars' => $vars));
			$css['vars'] = $rez['vars'];
		}
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($scheme) ? array_keys(freightco_get_sorted_schemes()) : array($scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $s) {
					// Prepare colors
					if (empty($scheme)) $colors = freightco_get_scheme_colors($s);
	
					// Make theme-specific colors and tints
					$colors = freightco_customizer_add_theme_colors($colors);
...
.sc_layouts_popup a:hover,
.trx_addons_popup a:hover {
	color: {$colors['alter_dark']};
}
.color_style_link2 a {
	color: {$colors['text_link2']};
...
[id*="cp_calculatedfieldsf"] select,
/* MailChimp */
...
[id*="cp_calculatedfieldsf"] select:focus,
[id*="cp_calculatedfieldsf"] select.filled,
/* MailChimp */
...
.sc_layouts_popup input[type="radio"] + label,
.sc_layouts_popup input[type="checkbox"] + label,
.sc_layouts_popup .wpcf7-list-item-label.wpcf7-list-item-right,
.trx_addons_popup input[type="radio"] + label,
.trx_addons_popup input[type="checkbox"] + label,
.trx_addons_popup .wpcf7-list-item-label.wpcf7-list-item-right {
	color: {$colors['alter_dark']} !important;
}
.sc_layouts_popup input[type="radio"] + label:before,
.sc_layouts_popup input[type="checkbox"] + label:before,
.sc_layouts_popup .wpcf7-list-item-label.wpcf7-list-item-right:before,
.trx_addons_popup input[type="radio"] + label:before,
.trx_addons_popup input[type="checkbox"] + label:before,
.trx_addons_popup .wpcf7-list-item-label.wpcf7-list-item-right:before {
...
.sc_button_simple.dark,
.sc_button_simple.dark:after {
	color:{$colors['text_dark']} !important;
}
.sc_button_simple.dark:hover,
.sc_button_simple.dark:hover:after {
	color:{$colors['text_link']} !important;
}
.scheme_self.elementor-widget-trx_sc_button .sc_button_simple.dark,
.scheme_self.elementor-widget-trx_sc_button .sc_button_simple.dark:after {
	color:{$colors['text_dark']} !important;
}
.scheme_self.elementor-widget-trx_sc_button .sc_button_simple.dark:hover,
.scheme_self.elementor-widget-trx_sc_button .sc_button_simple.dark:hover:after {
...
.hiring-acceptance .wpcf7-list-item-label{
    color: {$colors['text_dark']}; 
}
/* WooCommerce */
...
/* button alter */
/*.sc_layouts_popup button,
.sc_layouts_popup input[type="reset"],
.sc_layouts_popup input[type="submit"],
.sc_layouts_popup input[type="button"],*/
.sc_layouts_popup .sc_button_default.alter,
.sc_layouts_popup .sc_button.alter:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image),
.trx_addons_popup .sc_button_default.alter,
.trx_addons_popup .sc_button.alter:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image),
/*.scheme_self.sc_layouts_row button,
.scheme_self.sc_layouts_row input[type="reset"],
.scheme_self.sc_layouts_row input[type="submit"],
.scheme_self.sc_layouts_row input[type="button"],*/
.scheme_self.sc_layouts_row .sc_button_default.alter,
.scheme_self.sc_layouts_row .sc_button.alter:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image),
/*.scheme_self.top_panel .sc_layouts_row button,
.scheme_self.top_panel .sc_layouts_row input[type="reset"],
.scheme_self.top_panel .sc_layouts_row input[type="submit"],
.scheme_self.top_panel .sc_layouts_row input[type="button"],*/
.scheme_self.top_panel .sc_layouts_row .sc_button_default.alter,
.scheme_self.top_panel .sc_layouts_row .sc_button.alter:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image),
/*.scheme_self.top_panel .scheme_self.sc_layouts_row button,
.scheme_self.top_panel .scheme_self.sc_layouts_row input[type="reset"],
.scheme_self.top_panel .scheme_self.sc_layouts_row input[type="submit"],
.scheme_self.top_panel .scheme_self.sc_layouts_row input[type="button"],*/
.scheme_self.top_panel .scheme_self.sc_layouts_row .sc_button_default.alter,
.scheme_self.top_panel .scheme_self.sc_layouts_row .sc_button.alter:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image) {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}

/*.sc_layouts_popup button:hover,
.sc_layouts_popup button:focus,
.sc_layouts_popup input[type="submit"]:hover,
.sc_layouts_popup input[type="submit"]:focus,
.sc_layouts_popup input[type="reset"]:hover,
.sc_layouts_popup input[type="reset"]:focus,
.sc_layouts_popup input[type="button"]:hover,
.sc_layouts_popup input[type="button"]:focus,*/
.sc_layouts_popup .sc_button_default.alter:hover,
.sc_layouts_popup .sc_button.alter:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):hover,
.trx_addons_popup .sc_button_default.alter:hover,
.trx_addons_popup .sc_button.alter:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):hover,
/*.scheme_self.sc_layouts_row button:hover,
.scheme_self.sc_layouts_row button:focus,
.scheme_self.sc_layouts_row input[type="submit"]:hover,
.scheme_self.sc_layouts_row input[type="submit"]:focus,
.scheme_self.sc_layouts_row input[type="reset"]:hover,
.scheme_self.sc_layouts_row input[type="reset"]:focus,
.scheme_self.sc_layouts_row input[type="button"]:hover,
.scheme_self.sc_layouts_row input[type="button"]:focus,*/
.scheme_self.sc_layouts_row .sc_button_default.alter:hover,
.scheme_self.sc_layouts_row .sc_button.alter:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):hover,
/*.scheme_self.top_panel .sc_layouts_row button:hover,
.scheme_self.top_panel .sc_layouts_row button:focus,
.scheme_self.top_panel .sc_layouts_row input[type="submit"]:hover,
.scheme_self.top_panel .sc_layouts_row input[type="submit"]:focus,
.scheme_self.top_panel .sc_layouts_row input[type="reset"]:hover,
.scheme_self.top_panel .sc_layouts_row input[type="reset"]:focus,
.scheme_self.top_panel .sc_layouts_row input[type="button"]:hover,
.scheme_self.top_panel .sc_layouts_row input[type="button"]:focus,*/
.scheme_self.top_panel .sc_layouts_row .sc_button_default.alter:hover,
.scheme_self.top_panel .sc_layouts_row .sc_button.alter:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):hover,
/*.scheme_self.top_panel .scheme_self.sc_layouts_row button:hover,
.scheme_self.top_panel .scheme_self.sc_layouts_row button:focus,
.scheme_self.top_panel .scheme_self.sc_layouts_row input[type="submit"]:hover,
.scheme_self.top_panel .scheme_self.sc_layouts_row input[type="submit"]:focus,
.scheme_self.top_panel .scheme_self.sc_layouts_row input[type="reset"]:hover,
.scheme_self.top_panel .scheme_self.sc_layouts_row input[type="reset"]:focus,
.scheme_self.top_panel .scheme_self.sc_layouts_row input[type="button"]:hover,
.scheme_self.top_panel .scheme_self.sc_layouts_row input[type="button"]:focus,*/
.scheme_self.top_panel .scheme_self.sc_layouts_row .sc_button_default.alter:hover,
.scheme_self.top_panel .scheme_self.sc_layouts_row .sc_button.alter:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):hover {
	color: {$colors['inverse_dark']};
...
/* dark */
.sc_button.sc_button_default.dark {
	color: {$colors['bg_color']} !important;
	background-color: {$colors['text_dark']} !important;
}
.sc_button.sc_button_default.dark:hover {
	color: {$colors['text_dark']} !important;
...
.sc_layouts_row_type_narrow .sc_layouts_iconed_text a{
	color: {$colors['text_dark']};
}
.sc_layouts_row_type_narrow .sc_layouts_iconed_text a:hover{
	color: {$colors['text_link']};
}
.scheme_self.top_panel .sc_layouts_row_type_narrow .sc_layouts_iconed_text,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_iconed_text,
.scheme_self.top_panel .sc_layouts_row_type_narrow .sc_layouts_iconed_text a,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_iconed_text a{
	color: {$colors['alter_dark']};
}

.scheme_self.top_panel .sc_layouts_row_type_narrow .sc_layouts_iconed_text a:hover span,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_iconed_text a:hover span{
	color: {$colors['alter_link']};
}
...
.scheme_self.top_panel .sc_layouts_row_type_normal .sc_layouts_item a:not(.sc_button):not(.button),
.scheme_self.top_panel .scheme_self.sc_layouts_row_type_normal .sc_layouts_item a:not(.sc_button):not(.button),
...
.scheme_self.top_panel .sc_layouts_row_type_normal .sc_layouts_item .sc_layouts_menu.white a:not(.sc_button):not(.button),
.scheme_self.top_panel .scheme_self.sc_layouts_row_type_normal .sc_layouts_item .sc_layouts_menu.white a:not(.sc_button):not(.button),
.scheme_self.sc_layouts_row_type_normal .sc_layouts_item .sc_layouts_menu.white a:not(.sc_button):not(.button) {
	color: {$colors['alter_dark']};
}
.scheme_self.top_panel .sc_layouts_row_type_normal .sc_layouts_item .sc_layouts_menu.white a:not(.sc_button):not(.button):hover,
.scheme_self.top_panel .scheme_self.sc_layouts_row_type_normal .sc_layouts_item .sc_layouts_menu.white a:not(.sc_button):not(.button):hover,
.scheme_self.sc_layouts_row_type_normal .sc_layouts_item .sc_layouts_menu.white a:not(.sc_button):not(.button):hover {
	color: {$colors['alter_dark']};
}

.top_panel .sc_layouts_menu.sc_layouts_menu_default:not(.white):not(.alter) + .sc_layouts_menu_mobile_button .sc_layouts_item_link .sc_layouts_item_icon{
	color: {$colors['text_dark']} !important;
}
.top_panel.top_panel_default .sc_layouts_menu.sc_layouts_menu_default:not(.white):not(.alter) + .sc_layouts_menu_mobile_button .sc_layouts_item_link .sc_layouts_item_icon{
	color: {$colors['bg_color']} !important;
}
.top_panel.top_panel_default .sc_layouts_menu.sc_layouts_menu_default:not(.white):not(.alter) + .sc_layouts_menu_mobile_button .sc_layouts_item_link:hover .sc_layouts_item_icon{
	color: {$colors['text_link']} !important;
}
.top_panel .sc_layouts_menu.sc_layouts_menu_default:not(.white):not(.alter) + .sc_layouts_menu_mobile_button .sc_layouts_item_link:hover .sc_layouts_item_icon{
	color: {$colors['text_link']} !important;
}
.top_panel .sc_layouts_menu.sc_layouts_menu_default.white + .sc_layouts_menu_mobile_button .sc_layouts_item_link .sc_layouts_item_icon{
	color: {$colors['alter_dark']} !important;
}
.top_panel .sc_layouts_menu.sc_layouts_menu_default.white + .sc_layouts_menu_mobile_button .sc_layouts_item_link:hover .sc_layouts_item_icon{
	color: {$colors['alter_link']} !important;
}
.top_panel .sc_layouts_menu.sc_layouts_menu_default.alter + .sc_layouts_menu_mobile_button .sc_layouts_item_link .sc_layouts_item_icon{
	color: {$colors['alter_hover2']} !important;
}
.top_panel .sc_layouts_menu.sc_layouts_menu_default.alter + .sc_layouts_menu_mobile_button .sc_layouts_item_link:hover .sc_layouts_item_icon{
...
.sc_layouts_menu_nav:not(.sc_layouts_dropdown) > li.current-menu-item > a,
.sc_layouts_menu_nav:not(.sc_layouts_dropdown) > li.current-menu-parent > a,
.sc_layouts_menu_nav:not(.sc_layouts_dropdown) > li.current-menu-ancestor > a {
	color: {$colors['text_link']} !important;
}
.sc_layouts_menu_default.alter .sc_layouts_menu_nav > li > a{
	color: {$colors['bg_color']} !important;
}
.sc_layouts_menu_default.alter .sc_layouts_menu_nav > li > a:hover,
.sc_layouts_menu_default.alter .sc_layouts_menu_nav > li.sfHover > a {
	color: {$colors['text_dark']} !important;
}
.sc_layouts_menu_default.alter .sc_layouts_menu_nav > li.current-menu-item > a,
.sc_layouts_menu_default.alter .sc_layouts_menu_nav > li.current-menu-parent > a,
.sc_layouts_menu_default.alter .sc_layouts_menu_nav > li.current-menu-ancestor > a {
	color: {$colors['text_dark']} !important;
}
...
.sc_layouts_menu_default:not(.white):not(.alter) .sc_layouts_menu_nav .menu-collapse > a:before {
	color: {$colors['text_dark']};
}
...
.sc_layouts_menu_default.alter .sc_layouts_menu_nav .menu-collapse > a:hover:before {
	color: {$colors['text_dark']};
}
...
.top_panel .scheme_self.sc_layouts_row .sc_layouts_menu_nav li li:before,
.scheme_self.top_panel .sc_layouts_menu_nav li li:before,
.scheme_self.top_panel .scheme_self.sc_layouts_row .sc_layouts_menu_nav li li:before {
...
.top_panel .scheme_self.sc_layouts_row .sc_layouts_menu_nav li li:hover:before,
.scheme_self.top_panel .sc_layouts_menu_nav li li:hover:before,
.scheme_self.top_panel .scheme_self.sc_layouts_row .sc_layouts_menu_nav li li:hover:before {
	background-color: {$colors['extra_link']};
}
...
.scheme_self.top_panel_default .top_panel_title {
	background-color: {$colors['extra_bg_hover_085']};
}

.top_panel_default .sc_layouts_logo .logo_text,
.scheme_self.top_panel_default .sc_layouts_logo .logo_text {
	color: {$colors['alter_dark']};
}
.top_panel_default .sc_layouts_logo:hover .logo_text,
.scheme_self.top_panel_default .sc_layouts_logo:hover .logo_text {
	color: {$colors['alter_link']};
}

.top_panel_default  .sc_layouts_item a:not(.sc_button):not(.button),
.scheme_self.top_panel_default   .sc_layouts_item a:not(.sc_button):not(.button)  {
	color: {$colors['alter_dark']};
}

.top_panel_default .sc_layouts_item .menu_main_nav_area .menu-item a:not(.sc_button):not(.button),
.scheme_self.top_panel_default .sc_layouts_item .menu_main_nav_area .menu-item a:not(.sc_button):not(.button)  {
	color: {$colors['alter_dark']};
}
...
.freightco_tabs .freightco_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.freightco_tabs .freightco_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.post_layout_excerpt.sticky .post_counters .socials_share .socials_caption:before,
.post_layout_excerpt.sticky .post_counters .socials_share .socials_caption:hover:before {
...
.post_layout_excerpt.sticky .post_info_counters .post_counters_item:hover {
	color: {$colors['text_link']};
}
...
.wp-playlist .mejs-container .mejs-controls {
	background: {$colors['input_bg_color_07']};
}
...
.post_layout_excerpt .mejs-controls .mejs-button > button:hover,
.post_layout_excerpt .mejs-controls .mejs-button > button:focus {
	color: {$colors['alter_dark']};
}

.post_layout_excerpt .mejs-controls .mejs-time {
	color: {$colors['alter_dark']};
}
...
.mejs-controls .mejs-horizontal-volume-slider .mejs-horizontal-volume-total {
	background: {$colors['extra_link_03']};
}
...
.ua_edge .trx_addons_video_player.with_cover.video_play,
.ua_edge .trx_addons_video_player.with_cover.video_play .mask{
	background-color: transparent !important;
}
.ua_edge .trx_addons_video_player.with_cover.video_play .mask{
	opacity: 0 !important;
...
.related_wrap .related_item:before {
	background-color: {$colors['alter_bg_color_09']};
}

.related_wrap .related_item .post_title a{
	color: {$colors['alter_dark']};
}
.related_wrap .related_item .post_title a:hover{
	color: {$colors['alter_link']};
}
...
.related_wrap a.post_meta_item:hover,
.related_wrap .post_meta_item.post_categories a:hover {
	color: {$colors['alter_link']};
}

.related_wrap .post_meta_item.post_edit:before,
.related_wrap .post_meta_item.post_date:before,
.related_wrap .post_meta_item.post_counters_item:before,
.related_wrap .post_meta_item.post_categories:before {
	color: {$colors['alter_dark']};
}

.related_wrap .post_meta_item:after,
.related_wrap .post_meta_item:hover:after,
.related_wrap .post_meta .vc_inline-link:after,
.related_wrap .post_meta .vc_inline-link:hover:after,
.related_wrap .post_counters .socials_share .socials_caption:before,
.related_wrap .post_counters .socials_share .socials_caption:hover:before {
	color: {$colors['alter_bd_color']};
}
...
.related_wrap .related-more-link:hover {
	color: {$colors['alter_hover']};
}
...
.comments_list > li.trackback a{
	color: {$colors['text_link']};
}
.comments_list > li.trackback a:hover{
	color: {$colors['text_dark']};
}
...
.content .widget_calendar #prev a,
.content .widget_calendar #next a {
	color: {$colors['text_dark']};
}
.content .widget_calendar #prev a:hover,
.content .widget_calendar #next a:hover {
	color: {$colors['text_link']};
}
...
.scheme_self.footer_wrap .sc_layouts_menu_nav > li > a,
.footer_wrap .scheme_self.vc_row .sc_layouts_menu_nav > li > a {
	color: {$colors['alter_text']} !important;
}
...
.scheme_self.footer_wrap .sc_layouts_menu_nav > li.current-menu-item > a,
.scheme_self.footer_wrap .sc_layouts_menu_nav > li.current-menu-parent > a,
.scheme_self.footer_wrap .sc_layouts_menu_nav > li.current-menu-ancestor > a,
.footer_wrap .scheme_self.vc_row .sc_layouts_menu_nav > li.current-menu-item > a,
.footer_wrap .scheme_self.vc_row .sc_layouts_menu_nav > li.current-menu-parent > a,
.footer_wrap .scheme_self.vc_row .sc_layouts_menu_nav > li.current-menu-ancestor > a,
.scheme_self.footer_wrap .sc_layouts_menu_nav > li > a:hover,
.footer_wrap .scheme_self.vc_row .sc_layouts_menu_nav > li > a:hover {
	color: {$colors['alter_link']} !important;
}

.footer_wrap.footer_default .footer_copyright_inner,
.scheme_self.footer_wrap.footer_default .footer_copyright_inner{
	background-color: {$colors['extra_bg_color']};
}
...
.mfp-image-holder .mfp-close:before:hover,
.mfp-iframe-holder .mfp-close:before:hover,
.mfp-close-btn-in .mfp-close:before:hover {
	color: {$colors['text_link']};
}

.mfp-image-holder .trx_addons_popup .mfp-close:before,
.mfp-iframe-holder .trx_addons_popup .mfp-close:before,
.mfp-close-btn-in .trx_addons_popup .mfp-close:before,
.mfp-image-holder .sc_layouts_popup .mfp-close:before,
.mfp-iframe-holder .sc_layouts_popup .mfp-close:before,
.mfp-close-btn-in .sc_layouts_popup .mfp-close:before {
	color: {$colors['alter_dark']};
}
.mfp-image-holder .trx_addons_popup .mfp-close:hover:before,
.mfp-iframe-holder .trx_addons_popup .mfp-close:hover:before,
.mfp-close-btn-in .trx_addons_popup .mfp-close:hover:before,
.mfp-image-holder .sc_layouts_popup .mfp-close:hover:before,
.mfp-iframe-holder .sc_layouts_popup .mfp-close:hover:before,
.mfp-close-btn-in .sc_layouts_popup .mfp-close:hover:before {
	color: {$colors['alter_link']};
}
...
.elementor-progress-wrapper{
	background-color: {$colors['bd_color_068']};
}
...
div.ui-datepicker .ui-datepicker-today .ui-state-default,
...
CSS;
					...
					$rez = apply_filters('freightco_filter_get_css', $rez, array('colors' => $colors, 'scheme' => $s));
		...
		return apply_filters( 'freightco_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>