...
if ( ! function_exists( 'canava_options_plus_uri' ) ) {
	add_filter( 'op/directory_uri', 'canava_options_plus_uri' );
	 ...
	 * @return  string
	 */
	function canava_options_plus_uri( $uri ) {
...
if ( ! function_exists( 'canava_options_plus_path' ) ) {
	add_filter( 'op/directory_path', 'canava_options_plus_path' );
	 ...
	 * @return  string
	 */
	function canava_options_plus_path( $path ) {
