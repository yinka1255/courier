	...
	<div class="sc_portfolio_item_info">
		...
		if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) {
			...
			if (!empty($args['more_text'])) {
				?><div class="sc_portfolio_item_button sc_item_button"><a href="<?php echo esc_url($link); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_button sc_button_simple', 'sc_portfolio', $args)); ?>"><?php echo esc_html($args['more_text']); ?></a></div><?php
			}
		}
	?></div>
</div><?php
