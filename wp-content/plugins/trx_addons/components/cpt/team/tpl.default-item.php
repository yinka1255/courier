...
$alter_title_color = empty($args['alter_title_color']) ? '' : ' alter_color';
...
?>
<div <?php post_class( 'sc_team_item' . (empty($post_link) ? ' no_links' : '') . $alter_title_color ); ?>>
	<?php
	// Featured image
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters('trx_addons_filter_args_featured', array(
												...
												'no_links' => empty($link),
												'hover' => 'zoomin',
												'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size('relimg'), 'team-default')
												), 'team-default')
								);
	?>
