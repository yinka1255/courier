				...
				$this->add_control(
					...
					[
						...
						'condition' => [
							...
							'type' => ['default', 'modern', 'modern alter', 'number', 'alter', 'pictogram']
						]
					]
				);
					...
					[
						...
						'fields' => apply_filters('trx_addons_sc_param_group_params', array_merge(
							...
							[
								...
								[
									'name' => 'link_title',
									'label' => __( 'Link title', 'trx_addons' ),
									'label_block' => false,
									'description' => wp_kses_data( __("Only modern layout", 'trx_addons') ),
									'type' => \Elementor\Controls_Manager::TEXT,
									'placeholder' => __( 'link title', 'trx_addons' ),
								],
								[
									'name' => 'link',
								...
								[
									'name' => 'image_hover',
									'label' => __( 'Image Hover (only layout Image)', 'trx_addons' ),
									'type' => \Elementor\Controls_Manager::MEDIA,
									'default' => [
										'url' => '',
									],
