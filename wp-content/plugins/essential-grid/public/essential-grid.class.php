	...
	public function output_by_stream($grid_preview = false, $only_elements = false, $specific_ids = array()){
		...
		switch ($base->getVar($this->grid_postparams, 'stream-source-type')) {
			case 'twitter':
				...
				break;
			case 'instagram':
				$instagram = new Essential_Grid_Instagram($base->getVar($this->grid_postparams, 'instagram-access-key'),$base->getVar($this->grid_postparams, 'instagram-transient-sec',86400));
