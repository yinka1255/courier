//(function() {
	...
	// Wrapper function added by ThemeREX to correctly add listener
	// Without document.ready object jQuery('#eg-add-predefined-grid') is not exists
	jQuery( document ).ready(function() {
		...
		if(!jQuery('#eg-add-predefined-grid').hasClass('eg-clicklistener')){
			...
			jQuery('#eg-add-predefined-grid').addClass('eg-clicklistener')
				...
				.parents('#ess-grid-tiny-mce-dialog').attr('data-test', 1)
				.parents('#wpfooter').attr('data-ftest', 1).css('background-color', 'red');
